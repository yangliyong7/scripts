#!/usr/bin/env python3
"""Convert season/0509.html to docs markdown transcript."""

import re
from pathlib import Path

ROOT = Path(__file__).resolve().parents[1]
html = (ROOT / "season" / "0509.html").read_text(
...
Path(ROOT / "docs" / "Friends_S05E09_The_One_With_Ross_Sandwich.md").write_text(
    out, encoding="utf-8"
)
